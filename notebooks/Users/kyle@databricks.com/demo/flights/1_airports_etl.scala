// Databricks notebook source exported at Wed, 1 Jun 2016 23:19:03 UTC
// MAGIC %md #Load Airports Data
// MAGIC * Data for every airport can be found at [OpenFlights.org](http://openflights.org/data.html)
// MAGIC 
